...
export default function Category() {
  return (
    <section
      className="py-24 px-6 lg:px-20 bg-white dark:bg-[#0a0a0a]"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
        <div className="max-w-xl">
          ...
          <h2
            id="category-heading"
            className="text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-[0.9] tracking-tighter uppercase"
          >
          ...
          <p className="mt-6 text-sm font-bold text-gray-500 uppercase tracking-widest italic">
            Browse the widest selection of New & UK Used phones, laptops, TVs,
            and accessories at Shop B118.
          </p>
        </div>

        <Link
          href="/shop/smartphones"
          title="View all New and UK Used products in Kampala at Essimu Uganda"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {categoryData.map((item, index) => (
          <Link
            ...
            title={`Shop ${item.imageTitle} - Essimu Uganda Hub, William Street, Kampala`}
          ...
          >
            ...
            <div className="relative w-full aspect-[3/4] rounded-[2.5rem] overflow-hidden mb-8 shadow-sm bg-gray-50 dark:bg-[#111111] border border-gray-100 dark:border-white/5 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-blue-500/30 group-hover:-translate-y-2">
              ...
              <Image
                src={item.imageSrc}
                alt={`Buy ${item.imageTitle} at Essimu Uganda Shop B118, William Street, Kampala`}
                fill
            ...
            <div className="flex justify-between items-start px-2">
              <div>
                ...
                <p className="text-[10px] font-black text-[#0070f3] uppercase tracking-widest mt-2">
                  {item.imageTitle === "Smartphones"
                    ? "New & UK Used Grade-A"
                    : `Premium ${item.imageTitle}`}
                </p>
              </div>
