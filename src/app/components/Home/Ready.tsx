...
export default function ReadySection() {
    ...
    const handleWhatsAppOrder = () => {
        const message = encodeURIComponent("Hello Essimu Uganda, I saw your catalog and I want to order a phone/laptop.");
        window.open(`https://wa.me/${whatsappNumber}?text=${message}`, '_blank');
    };

    return (
        <section className="px-6 lg:px-20 py-24 bg-white dark:bg-[#0a0a0a]" aria-labelledby="ready-to-buy">
                ...
                <div className="relative z-10">
                    ...
                    <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full mb-8">
                        ...
                        <span className="text-[10px] font-black text-white uppercase tracking-[0.3em]">
                            Essimu Uganda • Shop B118 Live
                        </span>
                    </div>

                    <h2 id="ready-to-buy" className="text-5xl lg:text-7xl font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
                        Get Your <br/> <span className="text-white/60">Original Phone Today!</span>
                    </h2>
                    
                    <p className="text-blue-100 text-lg lg:text-xl font-medium max-w-2xl mx-auto mb-12 leading-relaxed italic">
                        New & UK Used phones available now at Shop B118. Battery checked, genuine, and ready to use. WhatsApp us for prices, availability, and delivery around Kampala.
                    </p>
                    ...
                    <div className="mt-16 pt-8 border-t border-white/10 flex flex-col items-center gap-2 opacity-60">
                        ...
                        <p className="text-[10px] text-blue-100 font-bold uppercase tracking-widest">Walk-ins welcome!</p>
                    </div>
                </div>
