    ...
    return (
        <div className="group relative flex flex-col h-full">
            ...
            <div className="relative w-full aspect-[3/4] rounded-[2.5rem] overflow-hidden mb-6 shadow-sm bg-gray-100 dark:bg-[#111111] border border-gray-100 dark:border-white/5 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-blue-500/30 group-hover:-translate-y-2">
                ...
                {/* --- THE IMAGE: Now set to cover and p-0 to reach edges --- */}
                <Image
                    src={item.image}
                ...
                {/* Deep Gradient Shield (Essential for text legibility on edge-to-edge images) */}
            ...
            <div className="flex justify-between items-start px-2 flex-1">
                <div className="flex-1">
                    ...
                    <h3 className="text-xl lg:text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-none group-hover:text-[#0070f3] transition-colors line-clamp-1">
                        {item.name}
                    </h3>
