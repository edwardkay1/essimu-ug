 ...
 * Optimized for WhatsApp-first buying behavior in Uganda.
 */
export function Order() {
  ...
  return (
    <button
      onClick={() =>
        window.open(
          `https://wa.me/${whatsappNumber}?text=Hello%20Esiimu%20Uganda%2C%20I%27m%20interested%20in%20buying%20a%20phone.%20Please%20assist%20me.`,
          "_blank"
        )
      }
    ...
    >
      <MessageSquare
        size={16}
        className="mr-3 fill-white group-hover:rotate-12 transition-transform"
      />
...
/**
 * HERO LEVEL CTA
 * Focused on phone sales (core business).
 */
 ...
 * Repairs positioned as professional support, not the main product.
 */
...
export function ViewAllBtn({
  ...
  return (
    <Link
      href={link}
      className="inline-flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-[#0070f3] hover:gap-6 transition-all group"
    >
...
/**
 * LIVE SHOP STATUS
 * Builds trust + physical presence (very important in Uganda).
 */
